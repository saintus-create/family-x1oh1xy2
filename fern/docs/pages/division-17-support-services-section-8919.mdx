---
title: "8919. (a) In order to establish a record by which an adoptee can prove the f"
description: "(a) In order to establish a record by which an adoptee can prove the f"
